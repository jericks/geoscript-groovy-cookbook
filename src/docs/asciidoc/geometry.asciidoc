...
The Geometry classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.14.0/geoscript/geom/package-summary.html[geoscript.geom]* package.
...
The *http://geoscript.github.io/geoscript-groovy/api/1.14.0/geoscript/geom/io/package-summary.html[geoscript.geom.io]* package
