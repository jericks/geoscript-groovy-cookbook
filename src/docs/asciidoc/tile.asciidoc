...
The Tile classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.22.0/geoscript/layer/package-summary.html[geoscript.layer]* package.
...
The Pyramid IO classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.22.0/geoscript/layer/io/package-summary.html[geoscript.layer.io]* package.
