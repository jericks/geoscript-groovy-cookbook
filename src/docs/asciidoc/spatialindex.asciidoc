...
The Index classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.21.0-SNAPSHOT/geoscript/index/package-summary.html[geoscript.index]* package.
