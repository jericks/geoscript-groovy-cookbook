...
The Feature classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.13.0/geoscript/feature/package-summary.html[geoscript.feature]* package.
...
The Schema IO classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.13.0/geoscript/feature/io/package-summary.html[geoscript.feature.io]* package.
...
The Feature IO classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.13.0/geoscript/feature/io/package-summary.html[geoscript.feature.io]* package.
