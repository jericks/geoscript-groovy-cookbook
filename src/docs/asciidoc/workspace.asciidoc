...
The Workspace classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.13-SNAPSHOT/geoscript/workspace/package-summary.html[geoscript.workspace]* package.
...
[source,groovy]
.The empty Workspace constructor creates an in Memory Workspace.  You can create a Layer by passing a name and a list of Fields.
----
