...
The Workspace classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.20-SNAPSHOT/geoscript/workspace/package-summary.html[geoscript.workspace]* package.
