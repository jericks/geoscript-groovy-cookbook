...
The Format classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.22.0-SNAPSHOT/geoscript/layer/package-summary.html[geoscript.layer]* package.
