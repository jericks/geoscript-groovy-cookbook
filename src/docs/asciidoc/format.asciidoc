...
The Format classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.17-SNAPSHOT/geoscript/layer/package-summary.html[geoscript.layer]* package.
...
Read a GTopo30 Raster from a File

[source,groovy]
----
include::{sourcedir}/geoscript/cookbook/FormatRecipes.groovy[tags=readGTopo30,indent=0]
----