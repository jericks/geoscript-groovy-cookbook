...
The Projection classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.22.0-SNAPSHOT/geoscript/proj/package-summary.html[geoscript.proj]* package.
