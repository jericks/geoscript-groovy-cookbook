...
The Projection classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.14-SNAPSHOT/geoscript/proj/package-summary.html[geoscript.proj]* package.
