...
The Filter classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.13-SNAPSHOT/geoscript/filter/package-summary.html[geoscript.filter]* package.
