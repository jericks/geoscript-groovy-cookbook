...
The Viewer classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.15-SNAPSHOT/geoscript/viewer/package-summary.html[geoscript.viewer]* package.
