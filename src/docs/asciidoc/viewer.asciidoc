...
The Viewer classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.16-SNAPSHOT/geoscript/viewer/package-summary.html[geoscript.viewer]* package.
