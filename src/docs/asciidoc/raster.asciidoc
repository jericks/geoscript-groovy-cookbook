...
The Raster classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.14-SNAPSHOT/geoscript/layer/package-summary.html[geoscript.layer]* package.
