...
Styles are found in the *http://geoscript.github.io/geoscript-groovy/api/1.21.0-SNAPSHOT/geoscript/style/package-summary.html[geoscript.style]* package.
...
Style Readers and Writers are found in the *http://geoscript.github.io/geoscript-groovy/api/1.21.0-SNAPSHOT/geoscript/style/io/package-summary.html[geoscript.style.io]* package.
...
Style Repositories can be found in the *http://geoscript.github.io/geoscript-groovy/api/1.21.0-SNAPSHOT/geoscript/style/package-summary.html[geoscript.style]* package.
