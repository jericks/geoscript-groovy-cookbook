...
The Process classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.22.0-SNAPSHOT/geoscript/process/package-summary.html[geoscript.process]* package.
