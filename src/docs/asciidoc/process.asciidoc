...
The Process classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.12-SNAPSHOT/geoscript/process/package-summary.html[geoscript.process]* package.
