...
The Render classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.14-SNAPSHOT/geoscript/render/package-summary.html[geoscript.render]* package.
