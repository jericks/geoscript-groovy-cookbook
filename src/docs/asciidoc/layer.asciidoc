...
The Layer classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.13-SNAPSHOT/geoscript/layer/package-summary.html[geoscript.layer]* package.
...
The Layer IO classes are in the *http://geoscript.github.io/geoscript-groovy/api/1.13-SNAPSHOT/geoscript/layer/io/package-summary.html[geoscript.layer.io]* package.
